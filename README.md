# Introduction 
Extended CoreUI (v2) by Anova (anovafawzi@gmail.com)
...
# Getting Started
1.	Installation process - clone this repo and run `npm install`
2.	Software dependencies - make sure you have latest npm
3.	Latest releases
4.	API references

# Build and Test
Code building will be done on the fly, as for test, please see example. To run the application, use `yarn start`.
